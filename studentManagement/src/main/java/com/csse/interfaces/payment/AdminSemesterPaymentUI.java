	...
	public AdminSemesterPaymentUI() {
		...
		btnSearch.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if(!textFieldStudentID.getText().trim().isEmpty()) {
					...
					table.setModel(DbUtils.resultSetToTableModel(SemesterPaymentHandler.adminSearchStudentWise(sid, year, semester)));
				}
		...
		btnSearchF.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				table.setModel(DbUtils.resultSetToTableModel(SemesterPaymentHandler.adminSearchFacultytWise(faculty, year, semester)));
			}
		});
